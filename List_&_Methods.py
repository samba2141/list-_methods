...
#n=[1,3.7,"python",[10,11]]

#n[3][0]=50
# print(n,type(n)) #[1,3.7,"python",[10,11]]  <list>
# print(n[0],type(n[0])) #1 <int>
# print(n[1],type(n[1])) #3.7  <float>
# print(n[2],type(n[2]))   #python <str>
# print(n[3],type(n[3]))   #[10,11] <list>
#print(n[4],type(n[4])) # indexerror : list index out of range
...
the end of the list"""
# n=[1,3.7,"hello",[10,11]]
# n.append(5)  #appnd means adding
# print(n)       #[1,3.7,"hello",[10,11],5]
# n.append("bye")
# print(n)

# n=[1,3.7,"hello",[10,11]]
# n.clear() #all cleared in blank[]
# print(n)
